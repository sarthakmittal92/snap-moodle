# Updates  
Neeraj, 21/11/21 : Updated requirements.txt; Commented out the unfinished change password thing.

## Basic Commands  
For back-end : python3 manage.py runserver, makemigrations, migrate --run-syncdb, shell, create_superuser

For front-end :
 - npm i -> To set up the environment
 - npm start -> To deploy
